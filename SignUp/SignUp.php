        ...
        <form class='Employee-SignUp-Form' action="" method='post'>
            <div class="Employee-SignUp-div-1">
                ...
                <div class="Employee-SignUp-Email">
                    ...
                    <input   type="email" name="email" value='<?php echo $email ?>' placeholder='Email Address' autocomplete='off' >
                    <span> <?php echo $emailErr ?></span>
                </div>

                <div class="Employee-SignUp-Phone">
                   <label for="">Contact Number:</label>
                    <input type="number" name="phone_number" min='0' value='<?php echo $phone_number ?>' placeholder='Contact Number' autocomplete='off' >
            ...
            <div class="Employee-SignUp-div-2">
                <div class="Employee-SignUp-Password">
                    ...
                    <input type="password" name="password" id='password' value='<?php echo $password?>' placeholder='Password' autocomplete='off' >
                    <span id='password_Err'> <?php echo $password_Err ?></span>
                 </div>
    
                <div class="Employee-SignUp-ConfirmPassword">
                   <label for="">Confirm Password:</label>
                    <input type="password" name="Confirmpassword" id='Confirmpassword' value='<?php echo $Confirmpassword?>' placeholder='Confirm Password' autocomplete='off'>
                    <span id='Confirmpassword_Err'> <?php echo $Confirmpassword_Err ?></span>
                </div>

                <div class="Employee-SignUp-Dob">
                    <label for="">Date of Birth:</label>
                    <input type='date' id='dob' name='dob' value='<?php echo $dob?>' autocomplete='off' >  
                    <span id='dob_Err'> <?php echo $dobErr ?></span>
                </div>
            </div>
            ...
            <div class="Employee-SignUp-div-3">
                <div class="Employee-SignUp-Pan">
                    ...
                    <input type='text' name='pan_no' id='pan_no' maxlength="10" value='<?php echo $pan_no ?>' placeholder='Pan Number' autocomplete='off' >
                    <span id='pan_no_Err'> <?php echo $pan_no_Err ?></span>
                </div>

                <div class="Employee-SignUp-Aadhar">
                    <label for="">Aadhar Number:</label>
                    <input type='number' name='aadhar_no' id='aadhar_no'  maxlength="12" min='0' value='<?php echo $aadhar_no ?>' placeholder='Aadhar Number' autocomplete='off' >
                    <span id='aadhar_no_Err'> <?php echo $aadhar_no_Err ?></span>
                </div>

                <div class="Employee-SignUp-Join">
                    <label for="">Date of joining:</label>
                    <input type='date' id='date_of_joining' name='date_of_join' value='<?php echo $date_of_join?>' autocomplete='off' >
                    <span id='date_of_joining_Err'> <?php echo $date_of_join_Err ?></span>
                </div>
            ...
            <div class="Employee-SignUp-div-4">
                ...
                <div class="Employee-SignUp-Address">
                    ...
                    <textarea name="address" placeholder='Permanant Residential Address' ><?php echo $address ?></textarea>
                    <span> <?php echo $addressErr ?></span>
                </div>
            
                <div class="Employee-SignUp-Profile file is-normal has-name ">
                    <label class="file-label">
                        <input accept="image/jpg,png,jpeg" class="file-input "  type="file" onchange="imageUploaded()" name="profile_photo_link" autocomplete='off'>
                    ...
                    <span id='profile_photo_link_Err'> <?php echo $profile_photo_link_Err ?></span>
                </div>
